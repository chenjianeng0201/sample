<ul class="layui-nav" lay-filter="">
    ...
    @if( Auth::check())
        <li class="layui-nav-item right @if(Route::is('users.show')) layui-this @endif" lay-unselect="">
            <a href="javascript:;"><img src="{{ Auth::user()->gravatar('140') }}" alt="{{ Auth::user()->name }}" class="layui-nav-img" />我</a>
            <dl class="layui-nav-child">
                <dd><a href="javascript:;">个人中心</a></dd>
                <dd><a href="javascript:;">编辑资料</a></dd>
